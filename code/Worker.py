...
class Worker:    
    ...
    def run(self):
        ...
        for review in self.dataset.reviews:
            ...
            direct_square_distance = ScoreService.calculate_square_distance(predicted_score, true_score)
            ...
            aspect_square_distance = ScoreService.calculate_square_distance(avg_aspect_score, true_score)
        ...
        print(f"Average square error for direct prediction: {direct_square_avg_error:.2f}")
        print(f"Average square error for aspect-based prediction: {aspect_square_avg_error:.2f}")
